...
public class player : MonoBehaviour
{
    ...
    void Player_Move()//プレイヤー移動操作
    {
        ...
        if (Input.GetKeyDown(KeyCode.LeftControl) && moveSpeed >= 9) slidingTimes = 9;
        ...
        if (Input.GetKeyUp(KeyCode.LeftControl)) sliding_cooltime = 3; else
        {
        ...
        if (velocity.magnitude >= 0.1) //動いたら...
        {
            ...
            ////////////////走り
            if (Input.GetKey(KeyCode.LeftControl) && moveSpeed >= 5  && Input.GetKey(KeyCode.W))
            {
    ...
    {
        print(collision.gameObject.tag == "Iwall");
